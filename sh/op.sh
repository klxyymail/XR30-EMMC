...
# =========================================================
# 基础变量（防止 $OP_author 为空导致 banner 异常）
# =========================================================
OP_author="kubulama"
...
# drop attendedsysupgrade（覆盖所有 luci collection 文件）
...
# 原版：把默认 uhttpd 替换为 luci-nginx（保留原版逻辑）
...
# =========================================================
# 【新增】第三方 LuCI 应用（iStore + 集客AC + tcpdump + Harbor File）
# =========================================================
# iStore 软件中心
...
# =========================================================
# 【关键修复】Banner 使用 'EOF' 防止单引号引发语法错误
# 这是原版编译失败的根本原因
# =========================================================
